      ...
      <div className="customer-header-container" style={{ flexShrink: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ textAlign: 'left' }}>
            <h1 className="customer-title" style={{ fontSize: '20px', fontWeight: '800', margin: 0 }}>Yard Attendant &bull; Scan In</h1>
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: '#000000',
                      border: hoverBtn === 'scan-in-btn' ? '2px solid #000000' : '1px solid transparent',
                      borderRadius: 12,
                      padding: '12px 20px',
                      fontSize: 13,
                      fontWeight: '800',
