  ...
  return (
    <div style={S.container}>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-2xl text-slate-900 leading-8 capitalize font-black flex items-center gap-2">
            Accounts &amp; Payroll <span className="text-slate-400 text-xl mx-1">•</span> Employee Pay
          </h1>
      ...
      <div style={S.operationsCard}>
        <div style={S.cardHeader}>
          <div style={S.cardTitleBlock}>
            <h2 style={{ ...S.cardTitle, fontSize: 15 }}>Employee Base Salaries</h2>
            <p style={{ ...S.cardSubtitle, fontSize: 12 }}>Manage office staff &amp; yard salaries.</p>
          </div>
          ...
          <div style={S.actionGroup}>
            <button 
              onClick={() => {
                setActiveBtn('export');
                showToast('Employee manifest exported successfully.');
              }}
              style={{
                ...S.btnSecondary,
      ...
      <div style={S.card}>
        <div style={S.cardHeader}>
          <div style={S.cardTitleBlock}>
            <h2 style={S.cardTitle}>Office staff &amp; Yard Salaries</h2>
          </div>
