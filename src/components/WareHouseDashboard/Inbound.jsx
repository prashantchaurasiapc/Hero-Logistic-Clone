    ...
    <div className="glass rounded-2xl p-5 border border-slate-200 text-left space-y-4 bg-white shadow-xs">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-2">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
          ...
          {/* Columns button */}
          <button className="inline-flex items-center gap-1.5 px-3 py-2 border border-slate-200 hover:bg-slate-50 text-slate-600 font-bold text-[9px] uppercase rounded-xl transition-all cursor-pointer focus:outline-none whitespace-nowrap shrink-0">
