      ...
      <div className="glass rounded-2xl p-5 border border-slate-200 text-left space-y-4 bg-white shadow-xs">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">Comprehensive view of all independent assets and staging cargo.</p>
          </div>
        ...
        <div className="flex flex-wrap justify-end items-center gap-3 relative">
            ...
            {['COMPACT', 'DEFAULT', 'RELAXED'].map((mode) => {
              ...
              return (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg transition-all duration-200 cursor-pointer ${isActive ? 'bg-[#FFD400] text-slate-955 font-extrabold shadow-xs' : 'text-slate-500 hover:text-slate-700'} whitespace-nowrap`}
                >
                  {mode}
                </button>
              );
          ...
          <button 
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 border border-slate-200 hover:bg-slate-50 text-slate-655 font-bold text-[9px] uppercase rounded-xl transition-all cursor-pointer focus:outline-none whitespace-nowrap shrink-0"
          >
          ...
          {columnsMenuOpen && (
            <div className="absolute right-0 top-full mt-2 z-20 w-48 bg-white border border-slate-200 rounded-2xl shadow-2xl p-4 animate-fade-in text-slate-800">
              <div className="flex justify-between items-center pb-2 border-b border-slate-100 mb-2">
                ...
                <button onClick={() => setColumnsMenuOpen(false)} className="text-slate-400 hover:text-slate-700">
                  <X className="h-3 w-3" />
                </button>
              </div>
                  ...
                  return (
                    <tr key={row.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      {visibleColumns.stockNo && (
                        <td className={`text-slate-500 font-semibold whitespace-nowrap ${getPaddingClass()}`}>
