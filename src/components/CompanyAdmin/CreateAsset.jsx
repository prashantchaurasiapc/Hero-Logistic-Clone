      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 md:p-8 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-sm font-black text-slate-900 uppercase tracking-widest">Asset Photo Upload</h2>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Upload asset photo to display across Table List & Asset Details</p>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="w-36 h-36 rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 flex flex-col items-center justify-center relative overflow-hidden shrink-0 group">
              {formData.photoUrl ? (
                <>
                  <img src={formData.photoUrl} alt="Asset Preview" className="w-full h-full object-cover" />
                  <button
                    type="button"
            ...
            <div className="flex-1 w-full space-y-3">
              <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest block">Upload Photo File</label>
              <input
                type="file"
                accept="image/*"
                onChange={(e) => {
                ...
                className="w-full text-xs text-slate-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100 cursor-pointer"
              />
              <p className="text-[10px] font-semibold text-slate-400">Supported formats: JPG, PNG, WEBP. Max file size: 5MB.</p>
            </div>
          </div>
        </div>
