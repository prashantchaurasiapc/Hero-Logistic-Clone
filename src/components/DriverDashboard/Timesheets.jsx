    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans p-4 sm:p-6 lg:p-8 space-y-6 pb-24 text-left">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-xs text-xs space-y-4">
        <div className="flex items-center gap-2 text-slate-800 font-black tracking-tight">
          ...
          <span>DEVELOPER NOTES – TIMESHEETS / CLOCK IN-OUT</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-slate-600 border-t border-slate-100 pt-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Allow drivers to clock in/out, track work hours and breaks.</li>
              <li>Ensure compliance with fatigue management rules.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Driver module (Driver).</li>
              <li>Users module.</li>
              <li>Geofence (Yard/Locations).</li>
              <li>Timesheets module.</li>
              <li>Break rules (Company Settings).</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Drivers can view their own timesheets.</li>
              <li>Edit allowed only within same day before submission.</li>
              <li>All records are logged.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Payroll System (Approved Timesheets).</li>
              <li>Compliance (Fatigue Monitoring).</li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              ...
              <li>Offline capture and auto sync when online.</li>
