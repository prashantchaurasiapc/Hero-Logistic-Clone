    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans p-4 sm:p-6 lg:p-8 space-y-6 pb-24 text-left">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-xs text-xs space-y-4">
        <div className="flex items-center gap-2 text-slate-800 font-black tracking-tight">
          ...
          <span>DEVELOPER NOTES – TRAILER SWAP / EQUIPMENT CHANGE</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-slate-600 border-t border-slate-100 pt-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Allow drivers to swap trailers or change equipment.</li>
              <li>Update truck-trailer assignment immediately.</li>
              <li>Follow company policy rules.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>View current driver, truck and trailer.</li>
              <li>Select available trailer from yard list.</li>
              <li>Record swap type, reason, date, time and location.</li>
              <li>Equipment check required to swap.</li>
              <li>Apply swap immediately (if allowed by policy).</li>
              <li>Dispatch notification based on policy.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Users module (Driver).</li>
              <li>Vehicles module (Trucks & Trailers).</li>
              <li>Yard/Locations module.</li>
              <li>Company settings (Company Policy).</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Drivers can swap assigned equipment.</li>
              <li>Role-based access control.</li>
              <li>Audit trail for all swaps.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Notifications (In-App/Push/Email).</li>
              <li>GPS for location capture.</li>
              <li>Audit trail for all swaps.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Trailer list validation in &lt; 2 seconds.</li>
              <li>Swap confirmation in &lt; 2 seconds.</li>
              <li>Real-time updates across platform.</li>
              <li>Optimized for mobile & web usage.</li>
            </ul>
          </div>
        </div>
      </div>
