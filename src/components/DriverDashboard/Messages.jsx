    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans p-4 sm:p-6 lg:p-8 space-y-6 pb-24 text-left">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-xs text-xs space-y-4">
        <div className="flex items-center gap-2 text-slate-800 font-black tracking-tight">
          ...
          <span>DEVELOPER NOTES – MESSAGES</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-slate-600 border-t border-slate-100 pt-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Enable real-time communication between drivers, dispatch, customers, and team.</li>
              <li>Keep all job-related communications in one place.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              ...
              <li>Message status (unread, read, important).</li>
              <li>Push notifications for new messages.</li>
              <li>Attach photos, documents, and location.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>User & contact data (Users module)</li>
              <li>Load & job data (Loads module)</li>
              <li>Contacts & customers module</li>
              <li>Message templates & notifications</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              ...
              <li>Only participants can view messages.</li>
              <li>End-to-end encrypted in transit & at rest.</li>
              <li>Audit trail for all messages.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              ...
              <li>Load details quick link.</li>
              <li>Driver notifications response.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Real-time sync via WebSocket or similar.</li>
              <li>Offline message queuing and auto-sync.</li>
