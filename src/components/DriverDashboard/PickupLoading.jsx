    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans p-4 sm:p-6 lg:p-8 space-y-6 pb-24 text-left">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-xs text-xs space-y-4">
        <div className="flex items-center gap-2 text-slate-800 font-black tracking-tight">
          ...
          <span>DEVELOPER NOTES – PICKUP & LOADING</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-slate-600 border-t border-slate-100 pt-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Allow driver to pick up all assigned cars at this location.</li>
              <li>Support flexible/owner-driver to add, remove or edit cars.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Scan VIN or select from list.</li>
              <li>Group cars by delivery stop.</li>
              <li>Add cars from pool/yard.</li>
              <li>Edit delivery destination or car details.</li>
              <li>Remove cars from load.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Loads module (assigned cars)</li>
              <li>Stops module (delivery destinations)</li>
              <li>Vehicles / Items module (car details)</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Validate VIN belongs to this pickup.</li>
              <li>Wrong car = show error and block.</li>
              <li>Add/Remove/Edit logged with driver, time, GPS and changes.</li>
              <li>When all required cars are picked up = enable Confirm.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Load status update</li>
              <li>Notifications (dispatch)</li>
              <li>Customer portal update (if enabled)</li>
              <li>Audit log</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              ...
              <li>Show sync status at top of page.</li>
