    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans p-4 sm:p-6 lg:p-8 space-y-6 pb-24 text-left">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-xs text-xs space-y-4">
        <div className="flex items-center gap-2 text-slate-800 font-black tracking-tight">
          ...
          <span>DEVELOPER NOTES – PAYROLL & PAY HISTORY</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-slate-600 border-t border-slate-100 pt-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Allow drivers to view earnings, deductions and payment history.</li>
              <li>Download payslips and tax statements.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Pay summary and breakdown.</li>
              <li>Pay history with status.</li>
              <li>Earnings vs deductions details.</li>
              <li>Next pay estimation.</li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              ...
              <li>Load module (Allowances).</li>
              <li>Tax & Company rules.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Drivers view own payroll only.</li>
              <li>Encrypted payroll data in transit & at rest.</li>
              <li>Audit trail for payroll changes.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Payroll System (Xero / MYOB).</li>
              <li>Accounting System.</li>
              <li>Bank Payment Gateway.</li>
              <li>ATO (STP) for Tax reporting.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-0.5 text-[11px] font-semibold">
              <li>Payroll data loads in &lt; 2 seconds.</li>
              <li>Payslip downloads in PDF.</li>
