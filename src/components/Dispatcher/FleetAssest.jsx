    ...
    try {
      ...
      const formatted = dbVehicles.map((v, index) => {
        ...
        return {
          ...
          year: v.year || 'N/A',
          vin: v.vin || 'N/A',
          totalTrips: v.odometerKm ? Math.floor(v.odometerKm / 500) : 0,
          mileage: v.odometerKm ? `${v.odometerKm} km` : 'N/A',
          gvmCapacity: v.gvm ? `${v.gvm}t` : 'N/A',
          rating: v.rating || 'N/A',
          lastService: 'N/A',
          nextService: v.nextServiceDate ? new Date(v.nextServiceDate).toLocaleDateString() : 'N/A',
          compliance: v.complianceStatus || 'Valid',
