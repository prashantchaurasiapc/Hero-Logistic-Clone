            ...
            <div className="flex items-center gap-6 border-b border-slate-200/80 overflow-x-auto pt-1">
              {[
                ...
                <button
                  ...
                  className={`py-2 text-xs font-bold whitespace-nowrap transition-all border-b-2 cursor-pointer ${activeTab === tab
            ...
            <div className="flex items-center gap-6 border-b border-slate-200/80 overflow-x-auto pt-1">
              {['Users', 'Roles', 'Permissions', 'Branch Access', 'Login & Security', 'Activity Log'].map((tab) => (
                <button
                  ...
                  className={`py-2 text-xs font-bold whitespace-nowrap transition-all border-b-2 cursor-pointer ${usersTab === tab
                      ? 'border-[#2563EB] text-[#2563EB]'
                      : 'border-transparent text-slate-500 hover:text-slate-800'
                    }`}
                >
            ...
            <div className="flex items-center gap-6 border-b border-slate-200/80 overflow-x-auto pt-1">
              {['Overview', 'Invoice Automation', 'Payment Reminders', 'Compliance Reminders', 'Load Status Actions', 'Customer Notifications', 'Approval Workflows'].map((tab) => (
                <button
                  ...
                  className={`py-2 text-xs font-bold whitespace-nowrap transition-all border-b-2 cursor-pointer ${workflowTab === tab
                      ? 'border-[#2563EB] text-[#2563EB]'
                      : 'border-transparent text-slate-500 hover:text-slate-800'
                    }`}
                >
            ...
            <div className="flex items-center gap-6 border-b border-slate-200/80 overflow-x-auto pt-1">
              {['Overview', 'Feature Settings', 'AI Models', 'Data Sources', 'Automation', 'AI Prompts & Templates', 'Usage & Limits', 'Logs & Monitoring'].map((tab) => (
                <button
                  ...
                  className={`py-2 text-xs font-bold whitespace-nowrap transition-all border-b-2 cursor-pointer ${aiTab === tab
                      ? 'border-[#2563EB] text-[#2563EB]'
                      : 'border-transparent text-slate-500 hover:text-slate-800'
                    }`}
                >
            ...
            <div className="flex items-center gap-0 border-b border-slate-200/80 overflow-x-auto pt-1">
              {['Overview', 'Connected Integrations', 'Available Integrations', 'API & Webhooks', 'Data Sync', 'Integration Logs', 'Settings'].map((tab) => (
                <button key={tab} onClick={() => setIntegrationsTab(tab)}
                  className={`py-2 px-3 text-xs font-bold whitespace-nowrap transition-all border-b-2 focus:outline-none focus:ring-0 outline-none cursor-pointer ${integrationsTab === tab ? 'border-[#2563EB] text-[#2563EB]' : 'border-transparent text-slate-500 hover:text-slate-800'
                    }`}>{tab}</button>
              ))}
            </div>
            ...
            <div className="flex items-center gap-0 border-b border-slate-200/80 overflow-x-auto pt-1">
              {['Overview', 'Notification Channels', 'Templates', 'Notification Rules', 'Recipient Groups', 'Communication Preferences', 'History & Logs'].map((tab) => (
                <button
                  ...
                  className={`py-2 px-3 text-xs font-bold whitespace-nowrap transition-all border-b-2 focus:outline-none focus:ring-0 outline-none cursor-pointer ${notificationsTab === tab ? 'border-[#2563EB] text-[#2563EB]' : 'border-transparent text-slate-500 hover:text-slate-800'
                    }`}
                >
                  {tab}
                </button>
            ...
            <div className="flex items-center gap-0 border-b border-slate-200/80 overflow-x-auto pt-1">
              {['Overview', 'Audit Logs', 'Login History', 'Security Events', 'Permission Changes', 'Data Access', 'Exports & Downloads', 'Blocked Actions', 'Settings'].map((tab) => (
                <button
                  ...
                  className={`py-2 px-3 text-xs font-bold whitespace-nowrap transition-all border-b-2 focus:outline-none focus:ring-0 outline-none cursor-pointer ${securityLogsTab === tab ? 'border-[#2563EB] text-[#2563EB]' : 'border-transparent text-slate-500 hover:text-slate-800'
                    }`}
                >
                  {tab}
                </button>
            ...
            <div className="flex items-center gap-0 border-b border-slate-200/80 overflow-x-auto pt-1">
              {['Overview', 'Plan & Usage', 'Add-ons', 'Invoices', 'Payment Methods', 'Billing History', 'Quotes & Orders'].map((tab) => (
                <button
                  ...
                  className={`py-2 px-3 text-xs font-bold whitespace-nowrap transition-all border-b-2 focus:outline-none focus:ring-0 outline-none cursor-pointer ${billingTab === tab ? 'border-[#2563EB] text-[#2563EB]' : 'border-transparent text-slate-500 hover:text-slate-800'
                    }`}
                >
                  {tab}
                </button>
