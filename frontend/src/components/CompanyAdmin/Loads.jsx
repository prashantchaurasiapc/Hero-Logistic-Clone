      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-4 sm:px-6 pt-4 sm:pt-6 pb-2 shrink-0 gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full md:w-auto">
          ...
          <div className="flex items-center gap-2 flex-1 sm:flex-initial">
            <button className="flex-1 sm:flex-initial justify-center flex items-center gap-1.5 px-3 py-2 bg-white border border-slate-200 rounded-xl text-xs font-semibold text-slate-600 hover:bg-slate-50 transition-colors whitespace-nowrap">
